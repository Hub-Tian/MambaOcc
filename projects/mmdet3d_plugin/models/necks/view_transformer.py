...
class LSSViewTransformer(BaseModule):
    ...
    def forward(self, input):
        ...
        x = self.depth_net(x)
        depth_end = time.time()
        # print('depthnet time=',(depth_end-depth_start)*1000)
        ...
        tmp = self.view_transform(input, depth, tran_feat)
        view_transform_end = time.time()
        # print('view transform time=',(view_transform_end - view_transform_start)*1000)
        return tmp
